...
/***/ "./static/js/portico/communities.js":
/*!******************************************!*\
  !*** ./static/js/portico/communities.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function sync_open_organizations_page_with_current_hash() {
    ...
    if (!hash || hash === "#all" || hash === "#undefined") {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".eligible_realm").show();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".realm-category").removeClass("selected");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`[data-category="all"]`).addClass("selected");
    } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".eligible_realm").hide();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.eligible_realm[data-org-type="${CSS.escape(hash.slice(1))}"]`).show();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".realm-category").removeClass("selected");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`[data-category="${CSS.escape(hash.slice(1))}"]`).addClass("selected");
    }
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on("hashchange", () => {
        sync_open_organizations_page_with_current_hash();
    });
});
...
/******/ 		"./static/js/portico/communities": "./static/js/portico/communities.js",
