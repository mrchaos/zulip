...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").on("click", ".scrub-realm-button", function (e) {
        e.preventDefault();
        const message =
            "Confirm the string_id of the realm you want to scrub.\n\n WARNING! This action is irreversible!";
        const actual_string_id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("string-id");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("a.copy-button").on("click", function () {
        Object(function webpackMissingModule() { var e = new Error("Cannot find module '../common'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this), "copytext");
    });
});
...
/******/ 		"./static/js/analytics/support": "./static/js/analytics/support.js",
...
/******/ 	__webpack_require__.O(undefined, ["vendors-node_modules_uppy_core_dist_style_css-node_modules_uppy_progress-bar_dist_style_css-n-dbfb16","vendors-node_modules_jquery_dist_jquery_js-node_modules_uppy_core_dist_style_css-node_modules-a12481","vendors-node_modules_sorttable_sorttable_js","static_third_bootstrap_css_bootstrap_css","static_js_bundles_common_js-static_js_debug_js"], () => (__webpack_require__("./static/js/analytics/support.js")))
