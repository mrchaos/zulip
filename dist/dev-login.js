...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-page-id='dev-login']").length > 0 && window.location.hash.slice(0, 1) === "#") {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[name='next']").each(function () {
            const new_value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("value") + window.location.hash;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("value", new_value);
        });
    }
});
...
/******/ 		"./static/js/portico/dev-login": "./static/js/portico/dev-login.js",
...
/******/ 	__webpack_require__.O(undefined, ["vendors-node_modules_uppy_core_dist_style_css-node_modules_uppy_progress-bar_dist_style_css-n-dbfb16","vendors-node_modules_jquery_dist_jquery_js-node_modules_uppy_core_dist_style_css-node_modules-a12481","static_third_bootstrap_css_bootstrap_css","static_js_bundles_common_js-static_js_debug_js","static_styles_components_css-static_styles_portico_markdown_css-static_styles_portico_portico-164839"], () => (__webpack_require__("./static/js/portico/dev-login.js")))
