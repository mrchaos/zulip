...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#toggle").on("change", () => {
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email-text").css("display") === "none") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email-text").each(function () {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).css("display", "block");
            });
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".email-html").each(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[type=radio][name=forward]").on("change", function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val() === "enabled") {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#forward_address_sections").show();
        } else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#forward_address_sections").hide();
        }
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#save_smptp_details").on("click", () => {
        const address =
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[name=forward]:checked").val() === "enabled" ? jquery__WEBPACK_IMPORTED_MODULE_0___default()("#address").val() : "";
        const csrf_token = jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[name="csrfmiddlewaretoken"]').attr("value");
        ...
        _channel__WEBPACK_IMPORTED_MODULE_1__.post({
            ...
            data,
            success() {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()("#smtp_form_status").show();
                setTimeout(() => {
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#smtp_form_status").hide();
                }, 3000);
            },
        });
    });
...
/******/ 		"./static/js/portico/email_log": "./static/js/portico/email_log.js",
...
/******/ 		"./static/styles/portico/email_log.css": "./static/styles/portico/email_log.css",
...
/******/ 					} else {
/******/ 						if(!/^(static_third_bootstrap_css_bootstrap_css|vendors\-node_modules_uppy_core_dist_style_css\-node_modules_uppy_progress\-bar_dist_style_css\-n\-dbfb16)$/.test(chunkId)) {
